...
- If the tile exposes `Download this image`, prefer clicking that button. This path was verified live on March 11, 2026.
...
- If a visible download button appears after opening the image, use it only if it yields a real file download more reliably than source extraction.
